...
export default function RegisterPage() {
    ...
    const inputClass =
        "w-full px-3 py-2 rounded-xl bg-white text-black border border-gray-300 focus:ring-2 focus:ring-black/30 focus:outline-none transition placeholder:text-gray-400";
                        ...
                        <Form className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <ErrorMessage name="userFirstName" component="p" className="text-red-500 text-xs mt-1" />
                                </div>

                                <div>
                                    <Field name="userLastName" placeholder="Last name" className={inputClass} />
                                    <ErrorMessage name="userLastName" component="p" className="text-red-500 text-xs mt-1" />
                                </div>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                />
                                <Lock className="absolute top-1/2 right-3 -translate-y-1/2 text-gray-500" size={18} />
